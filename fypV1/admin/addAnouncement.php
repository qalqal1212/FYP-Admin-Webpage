...
if (isset($_POST['btn_save'])) {
    ...
    $annDesc = $_POST['annDesc'];

    mysqli_query($con, "INSERT INTO ann(annTitle, annDesc) VALUES ('$annTitle', '$annDesc')") or die("Query is incorrect!");
    mysqli_close($con);

    $status = "New Record Inserted Successfully.
    </br></br><a href='viewAnn.php'>View Inserted Record</a>";
}
                            ...
                            <form name="form" method="post" action="">
                                ...
                                <table width="600" height="300">
                                    ...
                                    <tr>
                                        ...
                                        <td>:</td>
                                        <td><input type="text" name="annTitle" placeholder="Enter Your Title" required size="50" /></td>
                                    ...
                                    <tr>
                                        ...
                                        <td>:</td>
                                        <td><textarea rows="4" cols="52" name="annDesc" placeholder="Enter Announcement Description" required></textarea></td>
                                    </tr>
