  ...
  <body>
    ...
    <div class="container">
      ...
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">Disease: Food Poisoning</li>
      </ol>
      ...
      <div class="row">
        ...
        <div class="col-lg-8">
          ...
          <p class="lead"><b>Disease : Food Poisoning</b></p>
		  
		  <p>Disease that you have is Food Poisoning . Below have information of disease, herb recommendation and prescription method.</p>
		 
		  
		  <?php
				$count=1;
				$sel_query="Select * from disease where diseaseId = 'dis5';";
				...
				while($row = mysqli_fetch_assoc($result)) { ?>
                     ...
                     <?php $count++; } ?>
						...
						<?php
				$count=1;
				$sel_query="Select * from symptom where symId ='sym43' or symId ='sym26' or symId ='sym37' or symId ='sym27' or symId ='sym13' or symId ='sym19';";
				$result = mysqli_query($con,$sel_query);
				while($row = mysqli_fetch_assoc($result)) { ?>
				...
				<?php
				$count=1;
				$sel_query="Select * from images where id ='4' or id ='7' or id ='5' or id ='3' or id ='6';";
				$result = mysqli_query($con,$sel_query);
				while($row = mysqli_fetch_assoc($result)) { ?>
				...
				<h5>Prescription Method</h5>
					...
					<?php
				$count=1;
				$sel_query="Select * from prescription where prescriptionId ='pre1' or prescriptionId ='pre2' or prescriptionId ='pre3' or prescriptionId ='pre4' or prescriptionId ='pre5';";
				$result = mysqli_query($con,$sel_query);
				while($row = mysqli_fetch_assoc($result)) { ?>
