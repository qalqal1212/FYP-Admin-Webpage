  ...
  <body>
    ...
    <div class="container">
      ...
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">Disease: Constipation</li>
      </ol>
      ...
      <div class="row">
        ...
        <div class="col-lg-8">
          ...
          <p class="lead"><b>Disease : Constipation</b></p>
		  
		  <p>Disease that you have is Constipation. Below have information of disease, herb recommendation and prescription method.</p>
		 
		  
		  <?php
				$count=1;
				$sel_query="Select * from disease where diseaseId = 'dis2';";
				...
				while($row = mysqli_fetch_assoc($result)) { ?>
                     ...
                     <?php $count++; } ?>
						...
						<?php
				$count=1;
				$sel_query="Select * from symptom where symId ='sym21' or symId ='sym16' or symId ='sym31' 
				or symId ='sym41' or symId ='sym2';";
				$result = mysqli_query($con,$sel_query);
				while($row = mysqli_fetch_assoc($result)) { ?>
				...
				<?php
				$count=1;
				$sel_query="Select * from images where id ='12' or id ='13' or id ='14' or id ='15';";
				$result = mysqli_query($con,$sel_query);
				while($row = mysqli_fetch_assoc($result)) { ?>
				...
				<h5>Prescription Method</h5>
					...
					<?php
				$count=1;
				$sel_query="Select * from prescription where prescriptionId ='pre9' or prescriptionId ='pre10' or prescriptionId ='pre11' or prescriptionId ='pre12' ;";
				$result = mysqli_query($con,$sel_query);
				while($row = mysqli_fetch_assoc($result)) { ?>
