  ...
  <body>
    ...
    <div class="container">
      ...
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">Disease: Cough</li>
      </ol>
      ...
      <div class="row">
        ...
        <div class="col-lg-8">
          ...
          <p class="lead"><b>Disease : Cough</b></p>
		  
		  <p>Disease that you have is Cough. Below have information of disease, herb recommendation and prescription method.</p>
		 
		  
		  <?php
				$count=1;
				$sel_query="Select * from disease where diseaseId = 'dis3';";
				...
				while($row = mysqli_fetch_assoc($result)) { ?>
                     ...
                     <?php $count++; } ?>
						...
						<?php
				$count=1;
				$sel_query="Select * from symptom where symId ='sym36' or symId ='sym24' or symId ='sym14' 
				or symId ='sym1' or symId ='sym38';";
				$result = mysqli_query($con,$sel_query);
				while($row = mysqli_fetch_assoc($result)) { ?>
				...
				<?php
				$count=1;
				$sel_query="Select * from images where id ='19' or id ='20' or id ='21';";
				$result = mysqli_query($con,$sel_query);
				while($row = mysqli_fetch_assoc($result)) { ?>
				...
				<h5>Prescription Method</h5>
					...
					<?php
				$count=1;
				$sel_query="Select * from prescription where prescriptionId ='pre13' or prescriptionId ='pre14' or prescriptionId ='pre15';";
				$result = mysqli_query($con,$sel_query);
				while($row = mysqli_fetch_assoc($result)) { ?>
