  ...
  <body>
    ...
    <div class="container">
      ...
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">Herb: Guava Leaf</li>
      </ol>
      ...
      <div class="row">
        ...
        <div class="col-lg-8">
          ...
          <p class="lead"><b>Herb: Guava Leaf</b></p>
		  ...
		  <p>Below have information of herb.</p>
				...
				<?php
				$count=1;
				$sel_query="Select * from images where id ='4';";
		  ...
		  <h5>Guava Leaf Information</h5>
		  
		  <table class="table">
		  <?php
				$count=1;
				$sel_query="Select * from herb where herbId = 'herb1';";
				$result = mysqli_query($con,$sel_query);
				while($row = mysqli_fetch_assoc($result)) { ?>
