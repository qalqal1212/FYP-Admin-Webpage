  ...
  <body>
    ...
    <div class="container">
      ...
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">Disease: Diarrhea</li>
      </ol>
      ...
      <div class="row">
        ...
        <div class="col-lg-8">
          ...
          <p class="lead"><b>Disease : Diarrhea</b></p>
		  
		  <p>Disease that you have is Diarrhea. Below have information of disease, herb recommendation and prescription method.</p>
		 
		  
		  <?php
				$count=1;
				$sel_query="Select * from disease where diseaseId = 'dis6';";
				...
				while($row = mysqli_fetch_assoc($result)) { ?>
                     ...
                     <?php $count++; } ?>
						...
						<?php
				$count=1;
				$sel_query="Select * from symptom where symId ='sym40' or symId ='sym19' or symId ='sym37';";
				$result = mysqli_query($con,$sel_query);
				while($row = mysqli_fetch_assoc($result)) { ?>
