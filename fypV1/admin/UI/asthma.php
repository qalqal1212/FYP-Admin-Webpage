  ...
  <body>
    ...
    <div class="container">
      ...
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">Disease: Asthma</li>
      </ol>
      ...
      <div class="row">
        ...
        <div class="col-lg-8">
          ...
          <p class="lead"><b>Disease : Asthma</b></p>
		  
		  <p>Disease that you have is Asthma. Below have information of disease, herb recommendation and prescription method.</p>
		 
		  
		  <?php
				$count=1;
				$sel_query="Select * from disease where diseaseId = 'dis4';";
				...
				while($row = mysqli_fetch_assoc($result)) { ?>
                     ...
                     <?php $count++; } ?>
						...
						<?php
				$count=1;
				$sel_query="Select * from symptom where symId ='sym10' or symId ='sym39' or symId ='sym7' 
				or symId ='sym8' or symId ='sym28' or symId ='sym6';";
				$result = mysqli_query($con,$sel_query);
				while($row = mysqli_fetch_assoc($result)) { ?>
				...
				<?php
				$count=1;
				$sel_query="Select * from images where id ='20' or id ='15' or id ='19';";
				$result = mysqli_query($con,$sel_query);
				while($row = mysqli_fetch_assoc($result)) { ?>
				...
				<h5>Prescription Method</h5>
					...
					<?php
				$count=1;
				$sel_query="Select * from prescription where prescriptionId ='pre13' or prescriptionId ='pre14' or prescriptionId ='pre11';";
				$result = mysqli_query($con,$sel_query);
				while($row = mysqli_fetch_assoc($result)) { ?>
