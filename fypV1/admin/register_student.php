...
if (isset($_POST['btn_save'])) {
    ...
    mysqli_query($con, "INSERT INTO users(username, password, fname, email) VALUES ('$username', '$password', '$fname', '$email')") or die("Query is incorrect!");
    mysqli_close($con);

    $status = "New Record Inserted Successfully.
    </br></br><a href='viewStudent.php'>View Inserted Record</a>";
}
                            ...
                            <form name="form" method="post" action="">
                                ...
                                <table width="600" height="300">
                                    ...
                                    <tr>
                                        <td>Username</td>
                                        <td>:</td>
                                        <td><input type="text" name="username" placeholder="Enter Username" required size="50" /></td>
                                    ...
                                    <tr>
                                        <td>Password</td>
                                        <td>:</td>
                                        <td><input type="password" name="password" placeholder="Enter Password" required size="50" /></td>
                                    ...
                                    <tr>
                                        <td>Name</td>
                                        <td>:</td>
                                        <td><input type="text" name="fname" placeholder="Enter Name" required size="50" /></td>
                                    ...
                                    <tr>
                                        <td>Email</td>
                                        <td>:</td>
                                        <td><input type="text" name="email" placeholder="Enter Email" required size="50" /></td>

                                    </tr>

                                </table>

                                <p><input name="btn_save" type="submit" value="Save" /></p>
                            </form>
